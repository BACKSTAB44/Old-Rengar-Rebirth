...
linked: list[string] = {
    ...
    "DATA/Characters/Rengar/Rengar_Multi_Skins_Skin1_Skins_Skin4_Skins_Skin5_Skins_Skin6_Skins_Skin7.bin"
}
entries: map[hash,embed] = {
    "Characters/Rengar/Skins/Skin6" = SkinCharacterDataProperties {
        ...
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            texture: string = "ASSETS/Characters/Rengar/Skins/Skin06/rengar_Skin06_TX_CM.tex"
            skinScale: f32 = 0.9
