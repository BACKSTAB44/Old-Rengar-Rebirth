...
entries: map[hash,embed] = {
    "Characters/Rengar/Skins/Skin5" = SkinCharacterDataProperties {
        ...
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            texture: file = "assets/repath/characters/rengar/skins/skin05/rengar_skin05_tx_cm.tex"
            skinScale: f32 = 0.9
    ...
    "Characters/Rengar/Skins/Skin5/Particles/Rengar_Skin5_R_Leap" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                texture: string = "assets/repath/characters/rengar/skins/skin05/rengar_skin05_tx_cm.tex"
            }
        }
